...
The developer will acknowledge a valid request within 7 business days and will
complete deletion of applicable locally retained information within 30 days,
unless a longer retention period is required by law.

## Information covered by deletion

Where applicable, a deletion request may cover:

- locally stored Facebook or Instagram identifiers;
...
You may also revoke the application's access through your Facebook or
Instagram settings or through Facebook's **Business Integrations** settings.
Revoking access prevents future API access, but it may not automatically delete
information already stored locally or posts already published to a Page or
account. Send a deletion request using the process above if local deletion is
also required.

## Published and third-party data

Content already published to Facebook or Instagram can be deleted directly by
